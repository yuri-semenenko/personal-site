...
export function LeadershipSection({ items }: Props) {
  return (
    <Section id="leadership" eyebrow="03 / Leadership" title="Leadership & Engineering Impact">
        ...
        {items.map((item) => (
          <StaggeredItem key={item.title} className="flex flex-col rounded-lg border border-border bg-card p-6">
            ...
            <dl className="mt-5 space-y-4 text-sm">
              <div>
                <dt className="font-mono text-[0.6875rem] uppercase tracking-wide text-muted-foreground">Context</dt>
                <dd className="mt-1 leading-relaxed text-muted-foreground">{item.context}</dd>
              </div>
              <div>
                <dt className="font-mono text-[0.6875rem] uppercase tracking-wide text-muted-foreground">Action</dt>
                <dd className="mt-1 leading-relaxed text-muted-foreground">{item.action}</dd>
              </div>
              <div>
                <dt className="font-mono text-[0.6875rem] uppercase tracking-wide text-foreground">Outcome</dt>
