...
export function Section({ id, title, eyebrow, className, children, ...rest }: Props) {
  ...
  return (
    <section aria-labelledby={headingId} className={cn("px-4 py-16 sm:px-6 sm:py-20", className)} {...rest}>
      <div id={id} data-print-section className="mx-auto max-w-6xl scroll-mt-4">
