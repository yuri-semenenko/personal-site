...
export const education: EducationItemModel[] = [
  {
    ...
    description: "Five-year specialist degree (graduate) in Artificial Intelligence.",
  },
  {
    ...
    description: "Professional retraining programme in Web Design and Computer Graphics.",
  },
];
